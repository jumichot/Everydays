...
Elm.Bingo.make = function (_elm) {
   ...
   var totalPoint = function (entries) {
      return A3($List.foldl,F2(function (e,sum) {    return sum + e.points;}),0,A2($List.filter,function (_) {    return _.wasSpoken;},entries));
   };
   var pageFooter = A2($Html.footer,
   _U.list([]),
   _U.list([A2($Html.a,_U.list([$Html$Attributes.href("http://julienmichot.fr")]),_U.list([$Html.text("Julien Michot website")]))]));
   ...
   var entryList = F2(function (address,entries) {
      ...
      var items = A2($Basics._op["++"],entryItems,_U.list([totalItem(totalPoint(entries))]));
   ...
   var newEntry = F3(function (phrase,points,id) {    return A4(Entry,phrase,points,false,id);});
   ...
   var update = F2(function (action,model) {
      ...
      {case "NoOp": return model;
         ...
         case "Delete": var remainingEntries = A2($Debug.log,"RemainingEntries",A2($List.filter,function (e) {    return !_U.eq(e.id,_p0._0);},model.entries));
           return _U.update(model,{entries: remainingEntries});
         case "Mark": var entryToggleSpoken = function (e) {    return _U.update(e,{wasSpoken: $Basics.not(e.wasSpoken)});};
           var updateEntry = function (e) {    return _U.eq(e.id,_p0._0) ? entryToggleSpoken(e) : e;};
